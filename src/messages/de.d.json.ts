...
declare const messages: {
  ...
  "export": {
    ...
    "details": "Details",
    "dayNumber": "Tag {n}",
    "noDays": "Dieser Workshop hat noch keinen Tag.",
  ...
  "library": {
    ...
    "export": "Exportieren",
    "exportLabel": "{title} als Markdown exportieren",
  ...
  "mail": {
    ...
    "billing": {
      "trial_ending": {
        "subject": "Deine Testphase bei GoodWorkshop endet bald",
        "body": "Hallo,\n\ndeine kostenlose Testphase endet in {days, plural, one {einem Tag} other {# Tagen}}. Damit du danach weiterarbeiten kannst, hinterlege eine Zahlungsmethode:\n{link}\n\nOhne Zahlungsmethode bleibt alles lesbar und exportierbar, lässt sich aber nicht mehr ändern."
      },
      "payment_failed": {
      ...
      "readOnly": {
        "trial_ended": {
          "subject": "Dein Workspace ist jetzt schreibgeschützt",
          "body": "Hallo,\n\ndeine Testphase ist abgelaufen. Deine Workshops bleiben lesbar und exportierbar. Sobald du eine Zahlungsmethode hinterlegst, kannst du weiterarbeiten:\n{link}"
        },
        "payment_failed": {
          "subject": "Dein Workspace ist schreibgeschützt",
          "body": "Hallo,\n\nwir konnten eine Rechnung auch nach mehreren Versuchen nicht einziehen. Dein Workspace ist deshalb schreibgeschützt; lesen und exportieren geht weiterhin. Bitte kläre die Zahlung:\n{link}"
        }
      },
      "priceChange": {
        "per_user": {
          "subject": "Preisänderung bei GoodWorkshop ab {from}",
          "body": "Hallo,\n\nab {from} kostet GoodWorkshop {price} € netto pro Nutzer und Monat. Bis dahin gilt der bisherige Preis.\n\nWenn du damit nicht einverstanden bist, kannst du den Vertrag bis zum {from} zum Zeitpunkt des Wirksamwerdens kündigen:\n{link}"
        },
        "per_workshop": {
          "subject": "Preisänderung bei GoodWorkshop ab {from}",
          "body": "Hallo,\n\nab {from} kostet GoodWorkshop {price} € netto pro angelegtem Workshop. Bis dahin gilt der bisherige Preis.\n\nWenn du damit nicht einverstanden bist, kannst du den Vertrag bis zum {from} zum Zeitpunkt des Wirksamwerdens kündigen:\n{link}"
        }
      },
      "terms_change": {
        "subject": "Neue Vertragsbedingungen ab {from}",
        "body": "Hallo,\n\nwir haben unsere Bedingungen geändert. Die neue Fassung ({version}) gilt ab dem {from}; bis dahin gilt die bisherige.\n\nDen vollständigen Text findest du unter goodworkshop.org. Wenn die Änderung deine Rechte oder Pflichten nicht nur unwesentlich verändert, kannst du den Vertrag bis zum {from} kündigen:\n{link}"
      }
    }
  },
  "meta": {
  ...
  "site": {
    ...
    "home": {
      "title": "Workshops planen — mit einer Agenda, die sich selbst rechnet.",
      "lead": "GoodWorkshop ist der Workshop-Planer für Moderation und Facilitation: Tagesabläufe mit Uhrzeiten, Methoden und Verantwortlichen, live zu mehreren bearbeitet — und mit deiner KI verbunden.",
      ...
      "selfHostBody": "Der Quelltext von GoodWorkshop ist öffentlich. Wer eigene Server hat, installiert es dort mit Docker und zahlt uns nichts — weder heute noch später. Die Cloud nimmt dir Betrieb, Updates und Sicherung ab; das ist der einzige Unterschied.",
      ...
      "moreMethods": "Die Bausteine einer Agenda: fünfzehn Methoden, wofür sie taugen und wie lange sie dauern.",
      "moreFaq": "Häufige Fragen: Preise, Datenschutz, Selbst-Betreiben und die KI-Anbindung.",
      "moreCompare": "Du vergleichst mit SessionLab? Was GoodWorkshop anders macht — und wo es weniger kann."
    },
    "pricing": {
      "title": "Preise",
      ...
      "selfHost": {
        ...
        "unit": "auf eigenen Servern",
        "free": "für immer",
        "body": "Der Quelltext ist öffentlich, unter Apache 2.0 mit Commons Clause. Du darfst GoodWorkshop im eigenen Haus unbegrenzt nutzen und anpassen. Nicht erlaubt ist, es als eigenen Dienst zu verkaufen — deshalb ist die Lizenz keine Open-Source-Lizenz im Sinne der OSI.",
        "cta": "Zur Installation auf GitHub"
      }
    },
    "legal": {
    ...
    "meta": {
      "shareImageAlt": "Ein Workshoptag in GoodWorkshop: Blöcke mit Uhrzeit, Dauer und verantwortlicher Person.",
      "home": {
        "title": "GoodWorkshop: Workshops planen mit Agenda, Zeiten und KI",
        "description": "Der Workshop-Planer für Moderation und Facilitation: eine Agenda mit Uhrzeiten, die sich beim Verschieben selbst rechnen, live zu mehreren, zum Drucken und Exportieren. 14 Tage kostenlos."
      },
      "pricing": {
        "title": "Preise: pro Nutzer oder pro Workshop",
        "description": "Zwei Modelle, monatlich wechselbar: pro aktivem Mitglied oder pro angelegtem Workshop. Nettopreise für Unternehmen. 14 Tage kostenlos, ohne Zahlungsdaten."
      },
      "methods": {
        "title": "Workshop-Methoden: die Bausteine einer Agenda",
        "description": "Check-in, Gruppenarbeit, Entscheidung, Energizer: wofür jeder Baustein taugt, wie lange er üblicherweise dauert und in welcher Sozialform er läuft."
      },
      "compare": {
        "title": "SessionLab-Alternative: GoodWorkshop im Vergleich",
        "description": "Du suchst eine Alternative zu SessionLab? GoodWorkshop plant Workshop-Agenden, läuft in der EU oder auf deinem eigenen Server und ist mit deiner KI verbunden."
      },
      "faq": {
        "title": "Häufige Fragen",
        "description": "Was GoodWorkshop kostet, wo die Daten liegen, wie das Selbst-Betreiben funktioniert und was es mit der KI-Anbindung auf sich hat."
      },
      "impressum": {
        "title": "Impressum",
        "description": "Anbieterkennzeichnung nach § 5 ECG und § 25 MedienG für GoodWorkshop Cloud."
      },
      "agb": {
        "title": "Allgemeine Geschäftsbedingungen",
        "description": "Die Bedingungen, zu denen GoodWorkshop Cloud an Unternehmen verkauft wird."
      },
      "datenschutz": {
        "title": "Datenschutzerklärung",
        "description": "Welche Daten GoodWorkshop Cloud verarbeitet, wozu, wie lange und auf welcher Rechtsgrundlage."
      },
      "avv": {
        "title": "Auftragsverarbeitungsvertrag",
        "description": "Der Vertrag nach Art. 28 DSGVO zwischen dir als Verantwortlichem und roleALPHA als Auftragsverarbeiter."
      }
    },
    "register": {
    ...
    "methods": {
      "title": "Workshop-Methoden: die Bausteine einer Agenda",
      "lead": "Ein Workshoptag besteht aus Blöcken, und jeder Block hat einen Typ. Der Typ bestimmt, welche Felder mitkommen: der Arbeitsauftrag bei der Gruppenarbeit, das Verfahren bei der Entscheidung, die Impulsfrage beim Check-in. Hier stehen alle Bausteine, die GoodWorkshop mitbringt — wofür sie taugen, wie lange sie üblicherweise laufen und in welcher Sozialform.",
      "durationLabel": "Typische Dauer",
      "socialLabel": "Sozialform",
      "entries": {
        "admin": {
          "name": "Begrüßung & Organisatorisches",
          "body": "Der erste Block des Tages, und der einzige, in dem niemand mitdenken muss: Ablauf, Pausenzeiten, wo die Toiletten sind, wie mit Handys umgegangen wird. Je knapper er ausfällt, desto mehr Aufmerksamkeit bleibt für den Check-in danach. Halte ihn kurz und schreib die Spielregeln trotzdem auf — sie sind der Bezugspunkt, wenn später jemand dazwischenredet.",
          "duration": "10–15 Minuten",
          "social": "Plenum"
        },
        "check_in": {
          "name": "Check-in",
          "body": "Alle kommen einmal zu Wort, bevor die Arbeit beginnt. Das ist keine Höflichkeit, sondern Statik: wer im ersten Viertel nichts gesagt hat, sagt erfahrungsgemäß auch später wenig. Eine Frage, eine Runde, eine feste Zeit pro Person. Bei mehr als zwölf Personen lieber zu zweit als reihum, sonst kostet der Block eine halbe Stunde.",
          "duration": "10–20 Minuten",
          "social": "Plenum oder Paare"
        },
        "presentation": {
          "name": "Impuls / Präsentation",
          "body": "Jemand bringt Wissen in den Raum, das sonst niemand hat — Zahlen, Kontext, eine fachliche Grundlage. Der häufigste Fehler ist die Länge: ein Impuls über zwanzig Minuten ohne Gegenfrage kippt in Frontalunterricht. Plane die Verarbeitung gleich mit ein, als Gruppenarbeit oder Diskussion direkt danach.",
          "duration": "10–30 Minuten",
          "social": "Plenum"
        },
        "group_work": {
          "name": "Gruppenarbeit",
          "body": "Der Block, in dem die eigentliche Arbeit passiert. Entscheidend sind drei Angaben, die im Raum oft fehlen: der Arbeitsauftrag im Wortlaut, die Gruppengröße und was am Ende vorliegen soll. Rechne die Auswertung dazu — vier Gruppen à drei Minuten sind zwölf Minuten, die sonst aus der nächsten Pause kommen.",
          "duration": "30–60 Minuten",
          "social": "Kleingruppen"
        },
        "exercise": {
          "name": "Übung",
          "body": "Eine angeleitete Aktivität mit einem klaren Ablauf: Simulation, Rollenspiel, Planspiel, stilles Schreiben. Anders als die Gruppenarbeit ist das Verfahren vorgegeben und das Ergebnis offen. Notiere die Anleitung so, dass eine Vertretung sie vorlesen könnte, und verlinke die Methodenbeschreibung, wenn es eine gibt.",
          "duration": "20–45 Minuten",
          "social": "wechselnd"
        },
        "discussion": {
          "name": "Plenumsdiskussion",
          "body": "Alle reden miteinander über eine Leitfrage. Der Block, der am zuverlässigsten überzieht, weil er keine natürliche Grenze hat. Setz eine Zeit und eine Frage, und halte fest, worauf die Diskussion hinauslaufen soll: eine Entscheidung, eine Sammlung oder nur ein gemeinsames Bild.",
          "duration": "15–30 Minuten",
          "social": "Plenum"
        },
        "decision": {
          "name": "Entscheidung / Abstimmung",
          "body": "Aus vielen Optionen wird eine. Punktabfrage für Prioritäten, Fist of Five für Zustimmung, Konsent für Widerstände, Mehrheit für den Rest. Notiere vorher, welches Verfahren gilt und wer entscheidet — die Frage danach zu klären, ist der Grund, warum Workshops ohne Ergebnis enden.",
          "duration": "10–20 Minuten",
          "social": "Plenum"
        },
        "reflection": {
          "name": "Reflexion",
          "body": "Ein Blick zurück auf das, was gerade passiert ist: Was habe ich verstanden, was nehme ich mit, was ist offen geblieben? Erst einzeln und schriftlich, dann geteilt — sonst hört die Gruppe die Meinung der ersten Person und denkt in ihre Richtung weiter.",
          "duration": "10–20 Minuten",
          "social": "Einzelarbeit, dann Plenum"
        },
        "energizer": {
          "name": "Energizer",
          "body": "Fünf Minuten Bewegung gegen das Nachmittagsloch. Kein Füllmaterial: nach dem Mittagessen und nach zwei langen Blöcken hintereinander ist die Aufmerksamkeit messbar unten, und eine kurze Aktivität im Stehen holt mehr zurück als eine weitere Kaffeepause. Achte darauf, dass niemand vorgeführt wird.",
          "duration": "5–10 Minuten",
          "social": "Plenum, im Stehen"
        },
        "break": {
          "name": "Pause",
          "body": "Alle neunzig Minuten mindestens eine, und lieber fünfzehn Minuten als zehn: eine zu kurze Pause holt niemanden pünktlich zurück und frisst den Anfang des nächsten Blocks. In GoodWorkshop zählen Pausen getrennt vom Inhalt, damit im Kopf der Tagesplanung sichtbar ist, wie viel Arbeit tatsächlich drinsteckt.",
          "duration": "15 Minuten",
          "social": "keine"
        },
        "lunch": {
          "name": "Mittagessen",
          "body": "Der Block, der am häufigsten verschoben wird, und der, der am wenigsten verschoben werden darf — das Catering kommt, wann es kommt. Pinne ihn auf die Uhrzeit, dann bleibt er stehen, während sich alles andere darum herum bewegt.",
          "duration": "45–60 Minuten",
          "social": "keine"
        },
        "buffer": {
          "name": "Puffer",
          "body": "Bewusst leere Zeit. Jeder Workshop überzieht irgendwo, und ein eingeplanter Puffer ist der Unterschied zwischen einer Agenda, die sich anpasst, und einer, die ab halb drei nur noch falsch ist. Rechne mit zehn Prozent des Tages, und plane ihn vor die Blöcke, die nicht wegfallen dürfen.",
          "duration": "15–30 Minuten",
          "social": "keine"
        },
        "next_steps": {
          "name": "Nächste Schritte",
          "body": "Wer macht was bis wann. Der Block, an dem sich entscheidet, ob der Workshop im Arbeitsalltag ankommt oder als guter Tag in Erinnerung bleibt. Erfasse Verantwortliche und Fristen im Raum, solange alle da sind — hinterher fehlt immer die Hälfte.",
          "duration": "10–20 Minuten",
          "social": "Plenum"
        },
        "check_out": {
          "name": "Check-out",
          "body": "Eine letzte Runde, eine Frage, kurz. Sie dient nicht der Auswertung, sondern dem Abschluss: die Gruppe soll den Tag beenden und nicht einfach aufhören. Eine Stimmungsabfrage genügt, wenn die Zeit knapp ist.",
          "duration": "10–15 Minuten",
          "social": "Plenum"
        },
        "note": {
          "name": "Notiz",
          "body": "Kein Programmpunkt, sondern eine Bemerkung in der Agenda: eine Erinnerung an den Beamer, ein Hinweis für die Co-Moderation, ein Gedanke zur nächsten Fassung. Zählt keine Zeit und steht trotzdem an der richtigen Stelle.",
          "duration": "keine Dauer",
          "social": "keine"
        }
      },
      "howTitle": "Wie daraus ein Tag wird",
      "howBody": "Die Reihenfolge ist keine Geschmacksfrage. Ein Tag beginnt mit Ankommen und endet mit Abschluss; dazwischen wechseln sich Blöcke, in denen aufgenommen wird, mit Blöcken ab, in denen verarbeitet wird. Nach neunzig Minuten kommt eine Pause, nach dem Mittagessen etwas Bewegung, und vor dem Check-out stehen die nächsten Schritte. In GoodWorkshop verschiebst du die Blöcke, und alle Uhrzeiten dahinter rechnen sich neu — das Mittagessen bleibt trotzdem stehen, wenn du es auf die Uhrzeit pinnst.",
      "ctaTitle": "Aus den Bausteinen eine Agenda machen",
      "ctaBody": "Leg den Tag an, zieh die Blöcke in die Reihenfolge, die dir vorschwebt, und lass die Zeiten sich selbst ausrechnen. Oder beschreib deiner KI, was du vorhast, und lass sie den ersten Entwurf schreiben.",
      "cta": "14 Tage kostenlos testen"
    },
    "compare": {
      "title": "GoodWorkshop als Alternative zu SessionLab",
      "lead": "Beide Werkzeuge planen Workshop-Agenden, und beide nehmen dir das Rechnen mit Uhrzeiten ab. Diese Seite sagt, was GoodWorkshop anders macht — und am Ende, wo es weniger kann. Wer vergleicht, hat für Werbung ohnehin keine Verwendung.",
      "neutral": "SessionLab ist ein gehosteter Dienst für Sessiondesign mit einer großen öffentlichen Methodenbibliothek. Was dort steht, steht dort besser als hier; wir nennen keine Preise und keine Funktionen eines fremden Produkts, weil beides veraltet, sobald wir es hinschreiben. Sieh dort nach und vergleiche selbst.",
      "pointsTitle": "Was GoodWorkshop anders macht",
      "selfHost": {
        "title": "Du kannst es selbst betreiben",
        "body": "Der Quelltext ist öffentlich, und ein Docker-Container plus eine Postgres-Datenbank sind alles, was es braucht. Kommerzielle Nutzung eingeschlossen, ohne Lizenzkosten: die Workshops, mit denen du dein Geld verdienst, darfst du damit planen. Die Cloud verkauft den Betrieb, nicht den Zugang zur Software."
      },
      "ai": {
        "title": "Deine KI plant mit, ohne Zwischenschicht",
        "body": "GoodWorkshop ist selbst ein MCP-Server. Claude, ChatGPT oder Gemini verbinden sich direkt damit und legen Workshops an, schreiben Agenden um, parken Blöcke. Kein Kopieren aus dem Chatfenster, kein Zusatzprodukt — eine Verbindung, die du in den Einstellungen einrichtest."
      },
      "data": {
        "title": "Die Daten liegen, wo du sie haben willst",
        "body": "Die Cloud läuft in der EU, betrieben von einer österreichischen GmbH, mit Auftragsverarbeitungsvertrag. Wenn dir das nicht reicht, betreibst du es selbst — dann liegen sie in deinem Haus. In beiden Fällen holst du jede Agenda als Markdown wieder heraus, ohne zu fragen."
      },
      "pricing": {
        "title": "Zwei Preismodelle, auch für unregelmäßige Arbeit",
        "body": "Pro aktivem Mitglied und Monat, tagesgenau abgerechnet — oder pro angelegtem Workshop, mit beliebig vielen Mitgliedern. Das zweite Modell gibt es, weil Moderation oft in Wellen kommt: drei Workshops im Frühjahr, dann drei Monate nichts. Gäste zählen nie."
      },
      "room": {
        "title": "Gebaut für den Raum, nicht für die Vorbereitung allein",
        "body": "Die Agenda funktioniert auf dem Handy, übersteht schlechtes WLAN und lässt die Co-Moderation denselben Tag gleichzeitig bearbeiten. Moderationsnotizen bleiben bei dir: die Druckansicht und der Export lassen sie standardmäßig weg, damit die Gruppe die Agenda bekommt und du den Rest behältst."
      },
      "limitsTitle": "Wo GoodWorkshop weniger kann",
      "limitsBody": "GoodWorkshop hat keine öffentliche Methodenbibliothek mit hunderten fertigen Übungen und keine Galerie mit Vorlagen für jeden Anlass. Es bringt fünfzehn Bausteine mit, und die Inhalte schreibst du selbst — oder lässt sie dir von deiner KI schreiben. Es ist außerdem jünger und kleiner: weniger Integrationen, kein Team von dreißig Leuten dahinter. Wenn du eine fertige Übungssammlung suchst, bist du anderswo besser bedient. Wenn du eine Agenda suchst, die rechnet, die dir gehört und die deine KI bedienen kann, bist du hier richtig.",
      "ctaTitle": "Selbst ausprobieren",
      "ctaBody": "Vierzehn Tage, ohne Zahlungsdaten. Wenn es nicht passt, läuft es aus.",
      "cta": "Kostenlos testen",
      "ctaSecondary": "Selbst betreiben"
    },
    "faq": {
      "title": "Häufige Fragen",
      "lead": "Was am häufigsten gefragt wird, bevor jemand anfängt. Fehlt etwas, schreib uns — die Seite wächst mit den Fragen.",
      "entries": {
        "cost": {
          "q": "Was kostet GoodWorkshop?",
          "a": "Es gibt zwei Modelle, monatlich wechselbar: pro aktivem Mitglied und Monat, tagesgenau abgerechnet, oder pro angelegtem Workshop mit beliebig vielen Mitgliedern. Alle Preise sind netto, GoodWorkshop Cloud wird ausschließlich an Unternehmen verkauft. Die genauen Beträge stehen auf der Preisseite. Selbst betrieben kostet es nichts."
        },
        "free": {
          "q": "Ist GoodWorkshop kostenlos?",
          "a": "Auf deinem eigenen Server ja, dauerhaft und auch für kommerzielle Arbeit. Der Quelltext steht unter Apache 2.0 mit Commons Clause: du darfst GoodWorkshop unbegrenzt nutzen und anpassen, nur nicht als eigenen Dienst weiterverkaufen. Die Cloud kostet Geld, weil dort jemand den Betrieb, die Updates und die Sicherungen übernimmt. Die ersten vierzehn Tage sind kostenlos, ohne Zahlungsdaten."
        },
        "selfhost": {
          "q": "Kann ich GoodWorkshop selbst betreiben?",
          "a": "Ja, und das ist kein Nebenweg. Es braucht einen Container und eine Postgres-Datenbank; mit Docker Compose steht es in wenigen Minuten. Die Images liegen öffentlich für amd64 und arm64 bereit. Keine externen Dienste, kein Tracking, keine Lizenzschlüssel."
        },
        "data": {
          "q": "Wo liegen meine Daten?",
          "a": "In der Cloud in der EU, betrieben von der roleALPHA GmbH in Österreich, mit Auftragsverarbeitungsvertrag nach Art. 28 DSGVO. Betreibst du selbst, liegen sie dort, wo dein Server steht. In beiden Fällen exportierst du jede Agenda jederzeit als Markdown."
        },
        "ai": {
          "q": "Wie funktioniert die KI-Anbindung?",
          "a": "GoodWorkshop ist selbst ein MCP-Server — Model Context Protocol, die Schnittstelle, über die KI-Assistenten Werkzeuge bedienen. Du richtest die Verbindung einmal in den Einstellungen ein, danach können Claude, ChatGPT, Gemini und andere Clients Workshops anlegen, Agenden umschreiben, Blöcke parken und Tage verschieben. Die KI arbeitet in deinem Workshop, nicht in einem Chatfenster daneben."
        },
        "collab": {
          "q": "Können mehrere Personen gleichzeitig arbeiten?",
          "a": "Ja. Mehrere Personen bearbeiten denselben Tag live, ohne sich gegenseitig zu überschreiben. Kundinnen und Co-Moderation, die kein Konto haben, bekommen einen Link — lesend oder bearbeitend, wie du es einstellst."
        },
        "times": {
          "q": "Was passiert, wenn sich eine Zeit ändert?",
          "a": "Nichts, was du von Hand nachziehen müsstest. Verschiebst du einen Block oder änderst du eine Dauer, rechnen sich alle Uhrzeiten dahinter neu. Blöcke, die nicht wandern dürfen — das Mittagessen, der Slot der Kundin um 15:00 — pinnst du auf die Uhrzeit; kollidiert etwas damit, sagt die Zeile es, statt still zu kürzen."
        },
        "print": {
          "q": "Kann ich die Agenda drucken oder exportieren?",
          "a": "Ja, beides. Es gibt eine Druckansicht für den Raum und einen Markdown-Export für Handout und Dokumentation. Deine Moderationsnotizen bleiben in beiden standardmäßig außen vor."
        },
        "mobile": {
          "q": "Funktioniert das auf dem Handy?",
          "a": "Ja, und darauf ist es ausgelegt. Die Agenda liest sich im Raum als Karten auf dem Telefon, und die Ansicht übersteht schlechtes WLAN."
        },
        "migrate": {
          "q": "Ich arbeite schon mit einem anderen Werkzeug. Kann ich wechseln?",
          "a": "Einen automatischen Import gibt es nicht. Der schnellste Weg ist die KI-Anbindung: gib deinem Assistenten die bestehende Agenda als Text und lass ihn den Workshop in GoodWorkshop anlegen. Für einen einzelnen Tag ist das eine Sache von Minuten."
        }
      },
      "ctaTitle": "Noch eine Frage offen?",
      "ctaBody": "Am schnellsten beantwortet sie sich, indem du es ausprobierst: vierzehn Tage, ohne Zahlungsdaten.",
      "cta": "Kostenlos testen"
    }
  },
  "operator": {
    ...
    "signIn": {
      ...
      "intro": "Anmeldung mit Passkey. Kein Passkey zur Hand? Dann schicken wir dir einen Link.",
      "button": "Mit Passkey anmelden",
      "failed": "Anmeldung fehlgeschlagen.",
      "enrollTitle": "Passkey einrichten",
      "enrollIntro": "Richte den Passkey für {email} ein.",
      "enroll": "Passkey einrichten",
      "enrollInvalid": "Dieser Link ist ungültig oder abgelaufen. Einen neuen erzeugt scripts/operator.mjs enroll auf dem Server.",
      "mailTitle": "Per E-Mail anmelden",
      "mailIntro": "Wir schicken einen Link an die hinterlegte Adresse. Er gilt 15 Minuten und genau einmal.",
      "mailLabel": "E-Mail-Adresse",
      "mailButton": "Link schicken",
      "mailSent": "Wenn die Adresse zu einem Operator gehört, ist der Link unterwegs.",
      "mailSubject": "Anmeldung zur Operator-Konsole",
      "mailBody": "Mit diesem Link meldest du dich an der Operator-Konsole an. Er gilt 15 Minuten und genau einmal.\n\n{link}\n\nWenn du das nicht angefordert hast, ignoriere diese Nachricht — und sieh im Prüfprotokoll nach.",
      "linkTitle": "Anmeldung bestätigen",
      "linkIntro": "Noch ein Schritt: Mit „Anmelden“ bist du als {email} in der Konsole, danach gilt der Link nicht mehr. Der Schritt verhindert, dass Mailfilter den Link vor dir verbrauchen.",
      "linkButton": "Anmelden",
      "linkPending": "Wird angemeldet …",
      "linkInvalid": "Dieser Link ist ungültig, abgelaufen oder schon benutzt."
    },
    "passkeys": {
      "title": "Sicherheit",
      "intro": "Passkeys für {email}. Der Passkey ist der Weg hinein; der Link per E-Mail ist der Weg zurück, wenn kein Gerät mit Passkey zur Hand ist.",
      "none": "Noch kein Passkey. Bis dahin geht die Anmeldung nur über den Link per E-Mail.",
      "add": "Passkey einrichten",
      "adding": "Wird eingerichtet …",
    ...
    "tenants": {
      ...
      "all": "Alle",
      "apply": "Anzeigen",
      "count": "{count, plural, one {# Workspace} other {# Workspaces}}",
      "name": "Workspace",
      "state": "Status",
      "plan": "Modell",
      "members": "Mitglieder",
      ...
      "attention": "Offen",
      "created": "Angelegt",
      "held": "{count} in Prüfung",
      "failed": "{count} Zahlung fehlgeschlagen",
      "noPayment": "keine Zahlungsmethode"
    },
    "state": {
      "trial": "Testphase",
      "active": "Aktiv",
    ...
    "plan": {
      "per_user": "pro Nutzer",
      "per_workshop": "pro Workshop"
    },
    "detail": {
      "state": "Status",
      "trialEndsAt": "Testphase bis",
      "deleteAfter": "Löschung am",
      "plan": "Modell",
      "country": "Land · UID",
    ...
    "actions": {
      "title": "Aktionen",
      "reason": "Begründung (Pflicht, landet im Protokoll)",
      "pause": "Pausieren",
      "unpause": "Pause beenden",
      "block": "Sperren",
      "unblock": "Entsperren",
      "scheduleDeletion": "Löschung in {days} Tagen",
    ...
    "discover": {
      ...
      "source": "Quellsprache",
      "sourceHint": "Englisch ist die Quelle. Was hier fehlt, fehlt überall.",
      "reference": "Englisch",
      "notFound": "Diese Methode gibt es nicht.",
      "back": "Zurück zur Übersicht",
      "designsViaMcp": "Designs werden über MCP gepflegt: ein Tages- und Blockeditor hier wäre ein zweiter Agenda-Editor, und einen guten hat das Produkt bereits.",
      "filterValue": "Wert",
      "filterGroup": "Filter",
    ...
    "tokens": {
      "title": "MCP-Zugänge",
      "intro": "Ein Zugang für die Konsole über MCP. Er läuft ab, spätestens nach neunzig Tagen.",
      "name": "Name",
      "scopes": "Rechte",
      "days": "Gültig für (Tage)",
      "issue": "Ausgeben",
      "issued": "Einmal sichtbar. Danach nie wieder.",
      "none": "Kein Zugang ausgegeben.",
      "created": "Ausgegeben",
      "expires": "Läuft ab",
  ...
  "discover": {
    ...
    "parked": "Geparkt",
    "adoptTitle": "In deinen Workspace übernehmen",
    "adoptNew": "Als neuen Workshop",
    "adoptAppend": "An einen bestehenden Workshop anhängen",
    "adoptChoose": "Workshop wählen",
    "adoptSubmit": "Übernehmen",
    "adoptWorking": "Wird übernommen …",
    "adoptOpen": "Zum Workshop",
    "adoptDegraded": "{count, plural, one {# Block kam als Notiz an, weil dieser Workspace seinen Typ nicht hat.} other {# Blöcke kamen als Notiz an, weil dieser Workspace ihre Typen nicht hat.}}",
    "adoptDropped": "{count, plural, one {Bei # Block blieb die Beschreibung leer.} other {Bei # Blöcken blieb die Beschreibung leer.}}",
    "adoptDaysFailed": "{count, plural, one {# Tag konnte nicht geschrieben werden und ist leer.} other {# Tage konnten nicht geschrieben werden und sind leer.}}",
    "adoptNoWorkshops": "Du hast noch keinen Workshop, an den sich etwas anhängen ließe."
  }
};
