...
declare const messages: {
  ...
  "operator": {
    ...
    "discover": {
      ...
      "draft": "Entwurf",
      "key": "Schlüssel",
      "duration": "Ausgeschriebene Dauer",
      "slug": "Adresse",
      "name": "Name",
      ...
      "entries": "Einträge",
      "blocksViaMcp": "Tage und Blöcke werden über MCP gepflegt: ein Tages- und Blockeditor hier wäre ein zweiter Agenda-Editor, und einen guten hat das Produkt schon.",
      "dayCount": "{count, plural, one {# Tag} other {# Tage}}"
    },
    "tokens": {
      "title": "MCP-Zugänge",
  ...
  "discover": {
    "nav": "Discover",
    "title": "Discover",
    "lead": "Fertige Workshop-Abläufe und die Bausteine, aus denen sie bestehen — ganz zu übernehmen oder stückweise. Von uns kuratiert, nicht von der Menge.",
    "emptyTitle": "Hier ist noch nichts.",
    "emptyBody": "Die Bibliothek wird gerade aufgebaut. Einträge erscheinen hier, sobald sie geschrieben sind.",
