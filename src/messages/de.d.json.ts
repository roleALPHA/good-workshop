...
declare const messages: {
  ...
  "site": {
    ...
    "methods": {
      ...
      "cta": "14 Tage kostenlos testen",
      "emptyTitle": "Die Sammlung wird gerade geschrieben.",
      "emptyBody": "Sobald die ersten Methoden stehen, erscheinen sie hier.",
      "back": "Alle Methoden"
    },
    "compare": {
      ...
      "limitsBody": "Die Bibliothek von GoodWorkshop ist bewusst klein. Discover enthält eine kuratierte Sammlung von Methoden und fertigen Workshop-Designs, die wir selbst schreiben und pflegen: Dutzende, nicht Hunderte, und keine Galerie mit Vorlagen für jeden Anlass. Wer die größtmögliche Sammlung zum Stöbern sucht, ist anderswo besser bedient. GoodWorkshop ist außerdem jünger und kleiner: weniger Integrationen, kein Team von dreißig Leuten dahinter. Wenn du eine Agenda suchst, die rechnet, die dir gehört, die deine KI bedienen kann — und eine Handvoll Designs, die du in einem Schritt in einen Workshop übernimmst —, bist du hier richtig.",
  ...
  "discover": {
    ...
    "emptyBody": "Die Bibliothek wird gerade aufgebaut. Designs und Methoden erscheinen hier, sobald sie geschrieben sind.",
    "noMatchTitle": "Dazu passt nichts.",
    ...
    "kindLabel": "Was angezeigt wird",
    "kindAll": "Alles",
    "kindDesigns": "Designs",
    "kindMethods": "Methoden",
    "kindDesign": "Design",
    "kindMethod": "Methode",
    "loading": "Wird geladen …",
    "loadFailed": "Mehr konnte nicht geladen werden. Versuch es noch einmal.",
    "emptyDesignsTitle": "Noch keine Designs.",
    "emptyDesignsBody": "Designs werden aus Methoden gebaut, und die Methoden sind schon da.",
    "emptyDesignsLink": "Zu den Methoden",
    "emptyMethodsTitle": "Noch keine Methoden.",
    "emptyMethodsBody": "Die Bibliothek wird gerade aufgebaut. Sobald die ersten Methoden stehen, erscheinen sie hier.",
    "adoptMethodTitle": "In einen Workshop übernehmen",
    "adoptIntoDay": "In einen Tag eines bestehenden Workshops",
    "adoptChooseDay": "Tag wählen",
    "adoptNoDays": "Dieser Workshop hat keine Tage.",
    "adoptMethodOpen": "Zum Tag",
    "adoptMethodDegraded": "Sie kam als Notiz an: Dieser Workspace hat keinen passenden Blocktyp.",
    "adoptMethodDropped": "Sie kam ohne ihre Beschreibung an: Der Blocktyp dieses Workspace nimmt sie nicht an."
  }
};
